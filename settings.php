...
$base_url = 'http://54.173.205.6/mta/docroot';
...
$conf['404_fast_paths'] = '/\.(?:txt|png|gif|jpe?g|ico|swf|flv|cgi|bat|pl|dll|exe|asp)$/i';
$conf['fast_404_exts'] = '/\.(txt|png|gif|jpe?g|ico|swf|flv|cgi|bat|pl|dll|exe|asp)$/i';
$conf['404_fast_html'] = '<html xmlns="http://www.w3.org/1999/xhtml"><head><title>404 Not Found</title></head><body><h1>Not Found</h1><p>The requested URL "@path" was not found on this server.</p></body></html>';
 */
...
if (isset($_GET["q"]) && strpos($_GET["q"], "node/295986/webform-results/download") === 0) {
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_TICKET_dd.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_TICKET_dd.inc');
//</DDSETTINGS>
*/